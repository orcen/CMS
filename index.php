...
if( $_sC->_get('debug') == TRUE )	{
	...
	$content .= "<div style='position:absolute;right:0px; border:1px solid #DDD; background-color: #EFEFEF; font-size:10pt;'>".PHP_EOL
	. "<strong>DEBUG INFO</strong><br />".PHP_EOL
	. "<i>Configuration</i><br />".PHP_EOL
	. nl2br( $_sC->showVariables(TRUE) )
	. "<i>_POST Vars</i><br />".PHP_EOL
	. nl2br( print_r( $_POST, true ) )
	. "<i>_GET Vars</i><br />".PHP_EOL
	. nl2br( print_r( $_GET, true ) )
	. "<i>_SESSION Vars</i><br />".PHP_EOL
...
$markers = array(
  ...
  '###JSFILE1###' => 'http://code.jquery.com/jquery-1.8.2.js',
